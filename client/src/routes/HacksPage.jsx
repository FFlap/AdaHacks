...
import HackathonSwipeCard from '../components/swipe/Hackathonswipecard.jsx';
import AppShell from '../components/layout/AppShell.jsx';

// Interests/theme filters the user can toggle
const INTEREST_TAGS = [
...
export default function HacksPage() {
  ...
  // Filters
  const [mode, setMode] = useState('online'); // 'online' | 'location'
  ...
  // Fetch on mount with default filter (online)
  useEffect(() => {
    fetchHackathons();
